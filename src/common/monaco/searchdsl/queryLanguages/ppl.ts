...
export const pplLanguage: QueryLanguageDef = {
  ...
  syntax: {
    commands: [
      ...
      { label: 'rare', insertText: 'rare $0', description: 'Least common values', sortOrder: 14 },
      {
        label: 'trendline',
      ...
      { label: 'AD', insertText: 'AD $0', description: 'Anomaly detection', sortOrder: 16 },
      { label: 'ML', insertText: 'ML $0', description: 'Machine learning', sortOrder: 17 },
      {
        label: 'KMEANS',
        insertText: 'KMEANS $0',
