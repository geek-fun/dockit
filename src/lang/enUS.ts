export const enUS = {
  ...
  setting: {
    ...
    ai: {
      ...
      models: {
        ...
        filterModel: 'Search models...',
        noModelMatch: 'No models match your search.',
        recent: 'Recent',
    ...
    mcp: {
      ...
      permissionModeDesc: 'Control what operations the MCP bridge can perform',
      ...
      statusLoadFailed: 'Failed to load MCP bridge status',
      connectionsLoadFailed: 'Failed to load connections',
  ...
  manage: {
    ...
    docs: {
      ...
      pageInfo: 'Page {page}',
      viewJson: 'View JSON',
      selectIndexHint: 'Select an index to browse documents',
      selectConnectionHint: 'Select an Elasticsearch or OpenSearch connection',
      ...
      columnFilterClear: 'Clear',
      columnFilterApply: 'Apply',
      columnFilterNoValues: 'No values found',
      columnFilterLoading: 'Loading values…',
      columnFilterActive: '{count} selected',
      filterForValue: 'Filter for this value',
      excludeValue: 'Exclude this value',
      copyValue: 'Copy value',
      filterForColumn: 'Filter for this column',
      filterValueCopied: 'Copied',
  ...
  connection: {
    ...
    sshTunneledConnections: 'SSH Tunneled',
    advanced: 'Advanced',
    sortBy: {
      sortBy: 'Sort By',
      direction: 'Direction',
    ...
    ssh: {
      ...
      addProfilePlaceholder: 'Add an SSH profile...',
      ...
      sshAgentSockPath: 'SSH Agent Socket Path',
  ...
  editor: {
    ...
    exportFailure: 'Failed to export result',
