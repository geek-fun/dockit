export const enUS = {
  ...
  setting: {
    ...
    mcp: {
      ...
      modeReadOnly: 'Read-only — queries only, no modifications',
      modeDataReadWrite: 'Data read/write — CRUD allowed, no schema changes',
      modeFullAccess: 'Full access — all operations permitted',
